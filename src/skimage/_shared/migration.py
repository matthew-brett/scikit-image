...
def _parse_migration_doc(doc):
    ...
    if 'Summary' not in sections:
        raise ValueError("Migration docstring must contain a 'Summary' section defined by a Markdown heading.")
    if 'Examples' not in sections:
        raise ValueError("Migration docstring must contain an 'Examples' section defined by a Markdown heading.")
